...
import static com.example.avnijain.tictactoe.R.layout.activity_main;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void checkWin(String ch) {

        if( b1.getText().equals(ch) && b2.getText().equals(ch) && b3.getText().equals(ch))
        {
            disableButtons();
            showToast(ch);
        }

        else  if( b4.getText().equals(ch) && b5.getText().equals(ch) && b6.getText().equals(ch))
        {
            disableButtons();
            showToast(ch);
        }
        else  if( b7.getText().equals(ch) && b8.getText().equals(ch) && b9.getText().equals(ch))
        {
            disableButtons();
            showToast(ch);
        }
        else  if( b1.getText().equals(ch) && b4.getText().equals(ch) && b7.getText().equals(ch))
        {
            disableButtons();
            showToast(ch);
        }
        else  if( b2.getText().equals(ch) && b5.getText().equals(ch) && b8.getText().equals(ch))
        {
            disableButtons();
            showToast(ch);
        }
        else  if( b3.getText().equals(ch) && b6.getText().equals(ch) && b9.getText().equals(ch)) {
            disableButtons();
            showToast(ch);
        }

        else  if( b1.getText().equals(ch) && b5.getText().equals(ch) && b9.getText().equals(ch)) {
            disableButtons();
            showToast(ch);
        }

        else  if( b3.getText().equals(ch) && b5.getText().equals(ch) && b7.getText().equals(ch)) {
            disableButtons();
            showToast(ch);
        }
    ...
    private void showToast(String ch) {
        if(ch.equals("X"))
